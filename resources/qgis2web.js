...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [779276.673949, 8060632.746103, 833984.025685, 8088867.023206], maxZoom: 25, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32719',
...
map.addControl(layerSwitcher);
    ...
    var searchLayer = new SearchLayer({
      layer: lyr_Potenciales_Puntos_16,
      colName: 'Name',
      zoom: 10,
      collapsed: true,
      map: map
...
map.getView().fit([779276.673949, 8060632.746103, 833984.025685, 8088867.023206], map.getSize());
